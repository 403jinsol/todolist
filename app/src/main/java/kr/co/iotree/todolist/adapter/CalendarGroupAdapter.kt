...
class CalendarGroupAdapter(private val viewModel: CalendarViewModel, private val list: MutableList<Todo>, private val color: Int, private var supportFragmentManager: FragmentManager) : RecyclerView.Adapter<TodoItemViewHolder>() {
    ...
    override fun onBindViewHolder(holder: TodoItemViewHolder, position: Int) {
        holder.bindData(list[position], color, supportFragmentManager)
    }
