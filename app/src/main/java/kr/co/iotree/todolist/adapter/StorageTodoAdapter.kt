...
class StorageTodoAdapter(private val list: MutableList<Todo>, private var supportFragmentManager: FragmentManager) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): StorageTodoViewHolder {
        return StorageTodoViewHolder(ViewholderTodoItemBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
